...
#define CENT_ERR "Hundradelarna m√•ste ligga mellan noll och 99!"
#define CURR_ERR "Valutan skall vara ospecifierad (\"\") eller tre tecken l√•ng!"
#define CURR_ASS_ERR "Tv√• objekt med olika, specificerade, valutor kan ej tilldelas varandra!"
#define CURR_ADD_ERR "TvÂ objekt med olika, specificerade, valutor kan ej adderas!"
#define CURR_CMP_ERR "TvÂ objekt med olika, specificerade, valutor kan ej j‰mfˆras!"
